...
export default function Home() {
  ...
  return (
    <div className="max-w-4xl">
      <p className="font-mono text-xs sm:text-sm tracking-[0.25em] sm:tracking-[0.35em] text-zinc-400 uppercase mb-4 sm:mb-5">
        {t.home.hello}
      </p>
      ...
      <p className="text-red-500 font-mono text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-10">
        {t.home.role}
      </p>

      <p className="text-zinc-200 text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 leading-relaxed">
        {t.home.welcome}
      </p>
